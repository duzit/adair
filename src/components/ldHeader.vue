<template>
  <div>
    ...
    <div class="ld-header_component">
      <!-- <el-button
        class="button-style"
        :class="currentTab == 'javascript' ? 'is-actived' : ''"
        type="text"
        @click="pathTo('javascript', $event)">
        JavaScript
      </el-button>
      <el-button
        class="button-style"
        :class="currentTab == 'html' ? 'is-actived' : ''"
        type="text"
        @click="pathTo('html', $event)">
        HTML
      </el-button>
      <el-button
        class="button-style"
        :class="currentTab == 'css' ? 'is-actived' : ''"
        type="text"
        @click="pathTo('css', $event)">
        CSS
      </el-button>
      <el-button
        class="button-style"
        :class="currentTab == 'vue' ? 'is-actived' : ''"
        type="text"
        @click="pathTo('vue', $event)">
        Vue
      </el-button> -->
      <ul class="lists">
        <li @click="pathTo('javascript', 0)">
          JavaScript
        </li>
        <li @click="pathTo('html', 1)">
          HTML
        </li>
        <li @click="pathTo('css', 2)">
          CSS
        </li>
        <li @click="pathTo('vue', 3)">
          Vue
        </li>
      </ul>
    </div>
