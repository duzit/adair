...
*/
  ...
  \******************** */
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const _dedupe = __webpack_require__(/*! classnames/dedupe */ './node_modules/classnames/dedupe.js');

      const _dedupe2 = _interopRequireDefault(_dedupe);

      const _defaultAttrs = __webpack_require__(/*! ./default-attrs.json */ './src/default-attrs.json');

      const _defaultAttrs2 = _interopRequireDefault(_defaultAttrs);
      ...
      const Icon = (function() {
        function Icon(name, contents) {
          const tags = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
   ...
   */
        ...
        _createClass(Icon, [{
          ...
          value: function toSvg() {
            const attrs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

            const combinedAttrs = _extends({}, this.attrs, attrs, { class: (0, _dedupe2.default)(this.attrs.class, attrs.class) });
 ...
 */
  ...
  \********************* */
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const _icon = __webpack_require__(/*! ./icon */ './src/icon.js');

      const _icon2 = _interopRequireDefault(_icon);

      const _icons = __webpack_require__(/*! ../dist/icons.json */ './dist/icons.json');

      const _icons2 = _interopRequireDefault(_icons);

      const _tags = __webpack_require__(/*! ./tags.json */ './src/tags.json');

      const _tags2 = _interopRequireDefault(_tags);

      function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

      exports.default = Object.keys(_icons2.default).map((key) => {
  ...
  \********************* */
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const _icons = __webpack_require__(/*! ./icons */ './src/icons.js');

      const _icons2 = _interopRequireDefault(_icons);

      const _toSvg = __webpack_require__(/*! ./to-svg */ './src/to-svg.js');

      const _toSvg2 = _interopRequireDefault(_toSvg);

      const _replace = __webpack_require__(/*! ./replace */ './src/replace.js');

      const _replace2 = _interopRequireDefault(_replace);
  ...
  \*********************** */
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const _extends = Object.assign || function(target) { for (let i = 1; i < arguments.length; i++) { const source = arguments[i]; for (const key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /* eslint-env browser */
 ...
 */
      function replaceElement(element) {
        const attrs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

        const elementAttrs = getAttrs(element);
        const name = elementAttrs['data-feather'];
        delete elementAttrs['data-feather'];

        const svgString = _icons2.default[name].toSvg(_extends({}, attrs, elementAttrs, { class: (0, _dedupe2.default)(attrs.class, elementAttrs.class) }));
